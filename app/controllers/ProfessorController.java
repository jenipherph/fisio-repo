...
import models.Professor; // Professor.java
import models.ProfessorRepository; // ProfessorRepository.java
...
public class ProfessorController extends Controller {
    ...
    */
    private final FormFactory formFactory;
    private final ProfessorRepository professorRepository; //Link to the ProfessorRepository
    private final HttpExecutionContext ec;
